...
<table width="1000" height="200" align="center" border="1" cellpadding="3">
  ...
  <tr bgcolor="#F0FFF0">
    ...
    <td><div align="center">操作</div></td>
  	 ...
  	 <c:forEach items="${credents}" var="credential">
  		<tr bgcolor="#F0FFF0">
    		 ...
    		 <td><div align="center"><a href="/EduSystem/servlet/Adm_QueryCredential2Servlet?credentno=${credential.credentno }">查看</div></td>
  	   </tr>
  	 </c:forEach>	
   </table>
</body>
